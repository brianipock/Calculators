...
//Let it be know that a function has been selected
    var pendingFunciton  = $(this).text();
    $("#display").data("isPendingFunction", true);
    $("#display").data("thePendingFunction", pendingFunciton);
